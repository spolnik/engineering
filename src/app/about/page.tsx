...
export const metadata: Metadata = {
  title: "About",
  description:
    "About Engineering Lab, a software engineering media site focused on backend systems, platform engineering, and AI-assisted development.",
  alternates: {
    canonical: "/about",
  },
};
...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <SectionHeading
        eyebrow="About"
        title={`${siteConfig.name} is a home base for practical engineering media.`}
